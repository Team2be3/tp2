...
<link rel="stylesheet" type="text/css"
	href="<%=request.getContextPath()%>/resources/hotel.css">
<link rel="stylesheet" type="text/css"
		...
		<table class="table table-striped">
			...
			<c:forEach items="${devis}" var="de">
				<tr>
					...
					<td><a href="devis/ajouter${de.idDevis}"
						class="btn btn-success" role="button">Ajouter devis</a></td>
					<td><a href="devis/update/${de.idDevis}"
						class="btn btn-warning" role="button">Modifier</a></td>
					<td><a href="devis/delete/${de.idDevis}"
	...
	<div class="panel panel-default">
		<div class="panel-heading">
			<div class="panel panel-default">
				...
				<f:form class="form-horizontal" action="supprimerDevis"
					method="delete" modelAttribute="devS">
					<div class="form-group">
						<label class="control-label col-sm-2">Devis</label>
						<div class="col-sm-10">
							<select class="selectpicker" name="idDevis">
